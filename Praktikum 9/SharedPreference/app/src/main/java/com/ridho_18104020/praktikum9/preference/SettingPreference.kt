package com.ridho_18104020.praktikum9.preference
...
internal class SettingPreference(context: Context) {
    companion object {
        ...
        private const val KAMPUS = "kampus"
    ...
    fun setSetting(value: SettingModel) {
        ...
        editor.putString(KAMPUS, value.kampus)
    ...
    fun getSetting(): SettingModel {
        ...
        model.kampus = preferences.getString(KAMPUS, "")
